package com.contaazul.mars.server;
...
public class InMemoryServer implements AutoCloseable {
    ...
    private InMemoryServer(Object... objects) {

        append(objects);
    }


    public static InMemoryServer create(Object... objects) throws IOException {

        return create(null, objects);
    }


    public static InMemoryServer create(SecurityDomain securityDomain, Object... objects) throws IOException {

        InMemoryServer inMemoryRestServer = new InMemoryServer(objects);
